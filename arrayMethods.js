...
const sales = orders.map(elem => elem['price'] + (elem['price'] * elem['tax']))
console.log(sales)
...
const bobTotal = purchases.filter( elem => elem['owner'] === 'Bob').map(elem => elem['price']).reduce((acc, curr) => acc + curr)
